...
def mostrar_mensaje_bienvenida():
    ...
    tk.Label(area_dinamica, text="¡Bienvenida, Dali! ", font=("Arial", 14)).pack(pady=10)
    tk.Button(area_dinamica, text="Mostrar Mensaje", command=lambda: messagebox.showinfo("Bienvenida", "Buenos días Dali")).pack()
